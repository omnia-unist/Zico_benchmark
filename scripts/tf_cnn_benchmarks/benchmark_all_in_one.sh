...
if [ ${gpu_name} == V100 ]; then
  ...
  gpu_id=1
  # echo "GANGMUK_WARNING: /home/gangmuk/zico_experiment_set/benchmarks/scripts/tf_cnn_benchmarks/benchmark_all_in_one.sh"
  # echo "RTX has GPU_Id 0"
  # gpu_id=0
else
...
# gpustat -i &>  temp_gpustat &
# GPUSTAT_PID=$!
# mpstat -P ALL 1 &> ${directory}/cpuutil_${output_filename} &
# MPSTAT_PID=$!
